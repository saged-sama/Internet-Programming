...
#     bookings: Optional[ List["Booking"] ] = Relationship(back_populates="equipment")
...
# #     equipment_id: str
# #     equipment_status: EquipmentStatus
# #     available_slots: List[TimeRange]  # List of available time ranges
# #     booked_slots: List[TimeRange]     # List of booked time ranges