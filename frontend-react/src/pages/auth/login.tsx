...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        // For demo purposes, just check if email contains "admin", "faculty", or "student"
        const role = formData.email.includes('admin') ? 'admin' : 
                    formData.email.includes('faculty') ? 'faculty' : 
                    formData.email.includes('student') ? 'student' : 'user';
        
        // Store user info in localStorage (in a real app, you'd use secure storage and tokens)
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    onChange={handleChange}
                    className={`h-4 w-4 ${themeClasses.textPrimary} focus:ring-[${themeValues.colors.accentYellow}] border-gray-300 rounded`}
                  />
                ...
                <div className="text-sm">
                  <Link to="/auth/forgot-password" className={`font-medium ${themeClasses.textPrimary} hover:text-[${themeValues.colors.primaryLight}]`}>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                <div>
                  ...
                  >
                    <span className="sr-only">Sign in with University SSO</span>
            ...
            <div className="mt-6">
              <p className="text-center text-sm text-gray-600">
                ...
                <Link to="/auth/signup" className={`font-medium ${themeClasses.textPrimary} hover:text-[${themeValues.colors.primaryLight}]`}>
                  Sign up
                </Link>
              </p>
            </div>
